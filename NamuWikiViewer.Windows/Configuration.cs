...
public static class Configuration
{
    ...
    private const string ConfigurationDirectoryName = "SocialServiceWorkerServiceRecordAutomation";
    ...
    private static readonly string ConfigurationDirectoryPath = Path.Combine(BasePath, ConfigurationDirectoryName);
    private static readonly string ConfigurationFilePath = Path.Combine(ConfigurationDirectoryPath, ConfigurationFileName);
    private static readonly string ConfigurationBackupFilePath = Path.Combine(ConfigurationDirectoryPath, ConfigurationBackupFileName);
